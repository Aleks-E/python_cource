...
@pytest.mark.parametrize(
    ...
    [
        ("test_task_3_data_0.txt", tuple(0, 0)),
        ("test_task_3_data_1.txt", tuple(1, 1)),
        ("test_task_3_data_2.txt", tuple(8, 2)),
        ("test_task_3_data_3.txt", tuple(8, 1)),
        ("test_task_3_data_4.txt", tuple(8, 1)),
        ("test_task_3_data_5.txt", tuple(8, 1)),
        ("test_task_3_data_6.txt", tuple(8, 1)),
    ],
)
